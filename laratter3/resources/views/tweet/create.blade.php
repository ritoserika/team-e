        ...
        <div class="p-6 bg-white border-b border-gray-200">
          ...
          <form class="mb-6" action="{{ route('tweet.store') }}" method="POST">
            ...
            <div class="flex flex-col mb-4">
              <label class="mb-2 uppercase font-bold text-lg text-grey-darkest" for="tweet">チャンネル名</label>
              <input class="border py-2 px-3 text-grey-darkest" type="text" name="tweet" id="tweet">
            </div>
            <div class="flex flex-col mb-4">
              <label class="mb-2 uppercase font-bold text-lg text-grey-darkest" for="description">感想</label>
